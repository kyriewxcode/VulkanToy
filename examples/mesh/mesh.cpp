...
public:
	...
	{
		VkCommandBufferBeginInfo cmdBegineInfo = vks::initializers::commandBufferBeginInfo();
		...
		for (int32_t i = 0; i < drawCmdBuffers.size(); i++)
		{
			...
			auto cmd = drawCmdBuffers[i];

			VK_CHECK_RESULT(vkBeginCommandBuffer(cmd, &cmdBegineInfo));
